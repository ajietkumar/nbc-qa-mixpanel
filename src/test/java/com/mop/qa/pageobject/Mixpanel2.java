 ...
 *
 */
public class Mixpanel2 extends PageBase {
...
///////////////////////////////////////PEOPLE PROPERTY VALIDATION . VALIDATES IFTHE PROPERTY NAME IS VALIDATED UNDER THE PEOPLE PROFILE AS PRESENT OR NOT WITH ACTUAL VALUE
...
//////////////VERIFIES IF THE EVENT AND SUB EVENT TYPE EXISTS. MAKE SURE TO INCLUDE EVENT TYPE AND SUB EVENT TYPE IN THE DATA SHEET FOR CLICK ACTION,VIDEO START AND PAGE LOAD///////////////////////////////////////
...
////////////////////////////////////////////////////// CLICK ACTION AND ITS SUB EVENT TYPES//////////////////////////////////////////////////////////////////////
		else if (EventType.equalsIgnoreCase("Click Action")) 
		{
			...
			if (Parametercheck.get("Page Type:").equalsIgnoreCase("Responsive Global Home Page")&& (SubEvent_Type.equalsIgnoreCase("Responsive Global Home Page"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Page Type:").equalsIgnoreCase("Responsive Show Home Page")	&& (SubEvent_Type.equalsIgnoreCase("Responsive Show Home Page")))
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Collapse Content")&& (SubEvent_Type.equalsIgnoreCase("Video Details"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Expanded Content")&& (SubEvent_Type.equalsIgnoreCase("Expanded Content"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Carousel Click")&& (SubEvent_Type.equalsIgnoreCase("Dynamic Lead Slide"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Filter")&& (SubEvent_Type.equalsIgnoreCase("Clip Filter")))
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Activation")&& (SubEvent_Type.equalsIgnoreCase("Auth Funnel"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
		...
		{
			String CustomShelf = null;
			String CustomShelfValue=null;
		...
		try{
			...
			{
				System.out.println("CustomShelf object not found");
			...
			{
				System.out.println("Entitlement object not found");
				Entitlement=null;
		...
		if (Parametercheck.containsKey("Custom Shelf Title")) 
		{
			if ((Parametercheck.get("Custom Shelf Title:").equalsIgnoreCase("dynamic lead"))&& (SubEvent_Type.equalsIgnoreCase("Dynamic Lead"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			...
			else if ((Parametercheck.get("Custom Shelf Title:").equalsIgnoreCase("Smart Tile"))&& (SubEvent_Type.equalsIgnoreCase("Smart Tile"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
		}
		if (Parametercheck.containsKey("Entitlement:")) 
		{
		 if ((Parametercheck.get("Entitlement:").equalsIgnoreCase("free")) && (SubEvent_Type.equalsIgnoreCase("Free"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			
			else if ((Parametercheck.get("Entitlement:").equalsIgnoreCase("entitled"))&& (SubEvent_Type.equalsIgnoreCase("Entitled"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
		}
		 if (EventType.equalsIgnoreCase("Video Start") && SubEvent_Type.equalsIgnoreCase("Video Start")) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
...
/////////////////CLICKS SHOW MORE BUTTON TO SEARCH FOR EVENTS IN NEXT PAGE. NOT RECOMMENDED IF YOU ARE NOT ABLE TO RESET YOUR DISTINCT ID////////////////////////////////////////
...
///////////////////////// ACTUAL VALIDATION OF THE PROPERTY NAME AND VALUES GIVEN IN EACH SHEET FOR EACH EVENT
