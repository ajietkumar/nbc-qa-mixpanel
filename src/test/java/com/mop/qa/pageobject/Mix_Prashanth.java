 ...
 *
 */
public class Mix_Prashanth extends PageBase {

	public Mix_Prashanth() {
		super();
	}
	...
	public static boolean IsEventExists(String eventName, String EventType, String SubEvent_Type) throws Exception {
		...
		else if (EventType.equalsIgnoreCase("Click Action")) 
		{
			...
			if (Parametercheck.get("Page Type:").equalsIgnoreCase("show home page")	&& (SubEvent_Type.equalsIgnoreCase("show home page"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			} 
			else if (Parametercheck.get("Page Type:").equalsIgnoreCase("homepage")&& (SubEvent_Type.equalsIgnoreCase("homepage"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
			...
			else if (Parametercheck.get("Click Action Type:").equalsIgnoreCase("Carousel Click")&& (SubEvent_Type.equalsIgnoreCase("Dynamic Lead"))) 
			{
				// System.out.println(Parametercheck);
				EventExists = true;
			}
...
//		else if (EventType.equalsIgnoreCase("Video Start") && SubEvent_Type.equalsIgnoreCase("Dynamic Lead")) 
//		{
//			String CustomShelf = remoteDriver
//					.findElement(By
//							.xpath(".//*[@class='event_info has_properties active']/following-sibling::div/div//span[@class='property_name'][contains(text(),'Custom Shelf Title: ')]"))
...
//		
//		// =====================================Lakshmikanth==========================
//		else if (EventType.equalsIgnoreCase("Video Start") && SubEvent_Type.equalsIgnoreCase("Smart Tile")) {
//			String CustomShelf = remoteDriver
//					.findElement(By
//							.xpath(".//*[@class='event_info has_properties active']/following-sibling::div/div//span[@class='property_name'][contains(text(),'Custom Shelf Title: ')]"))
//					.getText().toString();
...
//			System.out.println(CustomShelfValue);
//			Parametercheck.put(CustomShelf, CustomShelfValue);
//			if ((Parametercheck.get("Custom Shelf Title:").equalsIgnoreCase("Smart Tile"))
//					&& (SubEvent_Type.equalsIgnoreCase("Smart Tile"))) {
//				// System.out.println(Parametercheck);
//				EventExists = true;
//			}
